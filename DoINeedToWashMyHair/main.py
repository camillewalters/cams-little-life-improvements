...
workoutStatus = input("Did you work out today? (y/n)")
if workoutStatus == 'y':
    print("You need to wash your hair because you worked out")
    quit()

dryShampooStatus = input("Did you use dry shampoo today or yesterday? (y/n)")
if dryShampooStatus == 'y':
    print("You need to wash your hair because you used dry shampoo")
    quit()
...
ApiKey='P9P6LA9Z4BHL3LDDU99RQK7KC'
...
#        ColIndex = 0
#        for Col in Row:
#            if ColIndex == 7 or ColIndex==9:
#                print('   ', FirstRow[ColIndex], ' = ', Row[ColIndex])
#            ColIndex += 1
#    RowIndex += 1

#just getting feelslike and humidity
feelslike=0
humidity=0
...
if feelslike > 31:
    print("You need to wash your hair because the temperature is", feelslike)
    quit()
if humidity > 65:
    print("You need to wash your hair because the humidity is", humidity)
    quit()

print("You don't absolutely have to wash your hair, but if its gross then yes")
